...
// 總額下面；每一行明細都能點看更細的拆解。
// ============================================================
import { listOrders, listAllReturns } from "./orders.js?v=20260830-98";
import { listItems, computeStock, computeAvgCost, STOCK_TRACKED_TYPES, buildItemsIndex } from "./items.js?v=20260830-98";
import { listExpensesInRange } from "./expenses.js?v=20260830-98";
import { renderDateRangePicker } from "./date-range-ui.js?v=20260830-98";
import { linkifyErrorMessage, friendlyErrorMessage } from "./utils.js?v=20260830-98";
