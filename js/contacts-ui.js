...
// 客戶與廠商頁面 UI
// ============================================================
import { showToast, linkifyErrorMessage, friendlyErrorMessage } from "./utils.js?v=20260830-69";
import { currentSession } from "./auth.js?v=20260830-69";
import { openModal, confirmDialog, openCustomTextModal } from "./modal-ui.js?v=20260830-69";
import { openSearchPicker } from "./picker-ui.js?v=20260830-69";
import { listContacts, createContact, updateContact, setContactArchived, ORDER_CHANNELS } from "./contacts.js?v=20260830-69";
import { listOrders, getPaymentStatus } from "./orders.js?v=20260830-69";
import { listCategories } from "./categories.js?v=20260830-69";
...
import { exportContacts } from "./export-xlsx.js?v=20260830-69";
import { setFab } from "./fab-ui.js?v=20260830-69";
