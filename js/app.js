...
// 主程式：登入流程 + 側邊導覽 + 簡易路由
// ============================================================
import { loginWithGoogle, logout, watchAuthState, currentSession, ROLE_LABELS, getDisplayName, consumeRedirectResult } from "./auth.js?v=20260829-48";
import { iconHtml } from "./icons.js?v=20260829-48";
import { pageNavHtml, wirePageNav } from "./page-nav.js?v=20260829-48";
import { openProfileModal } from "./profile-ui.js?v=20260829-48";
import { renderCloudinaryPage, renderPendingPage, renderMembersPage, renderCategoriesPage, renderUnitsPage, getPendingCount } from "./settings.js?v=20260829-48";
import { renderHomePage } from "./home.js?v=20260829-48";
import { renderItemsPage } from "./items-ui.js?v=20260829-48";
import { clearFab } from "./fab-ui.js?v=20260829-48";
import { renderContactsPage } from "./contacts-ui.js?v=20260829-48";
import { renderOrdersPage } from "./orders-ui.js?v=20260829-48";
import { renderReportsPage } from "./reports-ui.js?v=20260829-48";
import { renderProfitPage } from "./profit-ui.js?v=20260829-48";
import { renderActivityLogPage } from "./activity-log-ui.js?v=20260829-48";
import { renderExpensesPage } from "./expenses-ui.js?v=20260829-48";
import { lowStockItems } from "./items.js?v=20260829-48";
import { listOrders, getPaymentStatus, normalizeShipStatus } from "./orders.js?v=20260829-48";
import { showToast } from "./utils.js?v=20260829-48";
