...
// 主程式：登入流程 + 側邊導覽 + 簡易路由
// ============================================================
import { loginWithGoogle, logout, watchAuthState, currentSession, ROLE_LABELS, getDisplayName } from "./auth.js?v=20260826-3";
import { iconHtml } from "./icons.js?v=20260826-3";
import { pageNavHtml, wirePageNav } from "./page-nav.js?v=20260826-3";
import { openProfileModal } from "./profile-ui.js?v=20260826-3";
import { renderCloudinaryPage, renderPendingPage, renderMembersPage, renderCategoriesPage, renderUnitsPage, getPendingCount } from "./settings.js?v=20260826-3";
import { renderHomePage } from "./home.js?v=20260826-3";
import { renderItemsPage } from "./items-ui.js?v=20260826-3";
import { clearFab } from "./fab-ui.js?v=20260826-3";
import { renderContactsPage } from "./contacts-ui.js?v=20260826-3";
import { renderOrdersPage } from "./orders-ui.js?v=20260826-3";
import { renderReportsPage } from "./reports-ui.js?v=20260826-3";
import { renderProfitPage } from "./profit-ui.js?v=20260826-3";
import { renderActivityLogPage } from "./activity-log-ui.js?v=20260826-3";
import { renderExpensesPage } from "./expenses-ui.js?v=20260826-3";
import { lowStockItems } from "./items.js?v=20260826-3";
import { listOrders, getPaymentStatus } from "./orders.js?v=20260826-3";
import { showToast } from "./utils.js?v=20260826-3";
